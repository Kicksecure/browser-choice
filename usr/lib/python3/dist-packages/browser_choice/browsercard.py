...
from browsercard_ui import Ui_BrowserCard
...
class BrowserCard(QWidget):
    def __init__(
        ...
        super(BrowserCard, self).__init__(parent)
        ...
        if installed_method_list is None:
            ...
            for installed_method in installed_method_list:
                installed_method_text += f"<li>{installed_method}</li>"
            installed_method_text += "</ul>"
